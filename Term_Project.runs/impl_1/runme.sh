...
HD_PWD='C:/Users/pjjpj/source/repos/Morse_Term_Project/Term_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Morse_Transceiver_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Morse_Transceiver_Top.tcl -notrace
