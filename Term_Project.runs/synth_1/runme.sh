...
HD_PWD='C:/Users/pjjpj/source/repos/Morse_Term_Project/Term_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Morse_Transceiver_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Morse_Transceiver_Top.tcl
